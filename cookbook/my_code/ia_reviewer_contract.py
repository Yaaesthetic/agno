...
# Create PDF Knowledge Base for contract review guidelines
...
def review_contract(contract_file_path: str, user_context: Optional[UserContext] = None):
    
    contract_knowledge.load(upsert=True)
    ...
    contract_review_team = Team(
        ...
        Review the provided contract document. (it can a usually pdf)

        Process:
        1. First, have the Contract Analysis Agent review the document structure and detailed clause analysis
